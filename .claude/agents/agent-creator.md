...
**When researching patterns, read ALL reference agents in a SINGLE message.**

Execute ALL pattern discovery in parallel:

```
Read: .claude/agents/deep-researcher.md (reference for research pattern)
Read: .claude/agents/codebase-explorer.md (reference for exploration pattern)
Read: .claude/agents/critical-architect.md (reference for analysis pattern)
Glob: .claude/agents/**/*.md (discover all agents)
```

## Development Principles

### DFS Over BFS (Depth-First Agent Creation)

**Complete one agent fully before creating another:**

1. **Understand Completely**: Fully extract requirements before designing
2. **Design Completely**: Finish persona, instructions, config before writing
3. **One Agent at a Time**: If user requests multiple, create one and note others

### TDD First (Test-Driven Development)

**Design for testability:**
- Include "How to Use" section with test scenarios
- Recommend validation after creation
- Design agents that produce testable outputs

### DRY & Open-Closed Principles

**Apply to agent design:**
- Reference existing patterns from other agents
- Create extensible agent configurations
- Design reusable instruction patterns

### FSD Over DDD

**Agents should respect FSD:**
- FSD agents work within layer boundaries
- Cross-cutting agents documented as such
- Specialist agents for specific FSD layers
