...
**CRITICAL: Read ALL skill files in a SINGLE message.**

Execute ALL file discovery and reading in parallel:

```
Read: skills/{skill}/SKILL.md
Glob: skills/{skill}/references/*.md
Glob: skills/{skill}/examples/*
Glob: skills/{skill}/scripts/*
```

Then count words for all at once:

```
Bash: wc -w skills/{skill}/SKILL.md
Bash: wc -w skills/{skill}/references/*.md
Bash: find skills/{skill} -type f | wc -l
```

**Skill Review Process:**

1. **Locate and Read Skill (ALL FILES IN PARALLEL)**:
